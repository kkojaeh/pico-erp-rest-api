...
@Public
@Component
public class ProductionRequestAcceptedNotifyTypeDefinition implements
  NotifyTypeDefinition<ProductionRequestId, Object> {

  public static final NotifyTypeId ID = NotifyTypeId.from("production-request-accepted");
  ...
  public Object createContext(ProductionRequestId key) {
    ...
    val accepter = userService.get(productionRequest.getAccepterId());
