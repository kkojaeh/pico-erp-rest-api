...
@Public
@Component
public class OutsourcingRequestAcceptedNotifyTypeDefinition implements
  NotifyTypeDefinition<OutsourcingRequestId, Object> {

  public static final NotifyTypeId ID = NotifyTypeId.from("outsourcing-request-accepted");
  ...
  public Object createContext(OutsourcingRequestId key) {
    ...
    val accepter = userService.get(outsourcingRequest.getAccepterId());
