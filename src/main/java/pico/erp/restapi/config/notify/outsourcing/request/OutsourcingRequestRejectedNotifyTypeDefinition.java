...
@Public
@Component
public class OutsourcingRequestRejectedNotifyTypeDefinition implements
  NotifyTypeDefinition<OutsourcingRequestId, Object> {

  public static final NotifyTypeId ID = NotifyTypeId.from("outsourcing-request-rejected");
