package pico.erp.restapiserver;
...
import pico.erp.restapiserver.firebase.FirebaseAuthenticationProvider;
import pico.erp.restapiserver.firebase.FirebaseAuthenticationTokenFilter;
import pico.erp.restapiserver.sentry.SentryErrorHandler;
import pico.erp.restapiserver.web.CacheControlHandlerInterceptor;
  ...
  public static class SwaggerConfig {
    ...
    public Docket api() {
      return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("pico.erp.restapiserver"))
